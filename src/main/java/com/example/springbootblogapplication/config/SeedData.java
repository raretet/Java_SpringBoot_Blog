...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if(posts.size() == 0) {
            ...
            account1.setEmail("user.user@domail.com");
            ...
            account2.setFirstName("OSW");
            account2.setLastName("Club");
            account2.setEmail("rassadnev200777@gmail.com");
            account2.setPassword("Raretet228");
            ...
            Post post1 = new Post();
            post1.setTitle("title of the post 1");
            post1.setBody("This is a body of a post 1");
            post1.setAccount(account1);

            Post post2 = new Post();
            post2.setTitle("title of the post 2");
            post2.setBody("This is a body of a post 2");
